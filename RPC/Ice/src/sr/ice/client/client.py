    ...
    with Ice.initialize(['--Ice.Config=config.client'] + sys.argv) as communicator:
        ...
        while True:
            ...
            if args[0] == 'humidifier':
                ...
                if args[1] == 'settings':
                    ...
                    if args[2] == 'set':
                        ...
                        except SmartHome.IntensityRangeError:
                            print("Please provide proper intensity.")
                        except SmartHome.WorkTimeRangeError:
                            print("Please provide proper work time.")
            ...
            if args[0] == 'temperature':
                base = communicator.propertyToProxy("TempSensor1.Proxy")
