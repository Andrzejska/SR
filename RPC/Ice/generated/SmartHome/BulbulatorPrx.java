...
{
    default boolean toggleState()
    {
        return toggleState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean toggleState(java.util.Map<String, String> context)
    {
        return _iceI_toggleStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> toggleStateAsync()
    {
        return _iceI_toggleStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> toggleStateAsync(java.util.Map<String, String> context)
    {
        return _iceI_toggleStateAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_toggleStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "toggleState", null, sync, null);
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getState", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
