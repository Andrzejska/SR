...
public interface LightBulbPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        toggleState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void toggleState(java.util.Map<String, String> context)
    {
        _iceI_toggleStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> toggleStateAsync()
    {
        return _iceI_toggleStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> toggleStateAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_toggleStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "toggleState", null, sync, null);
